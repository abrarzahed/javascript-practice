...
// condition 7
const dogsWithOkAmountOfFood = dogs.filter(checkOkAmount);
console.log(dogsWithOkAmountOfFood);

// condition 8
const sortedDogsCopy = dogs.slice().sort((a, b) => a.recFood - b.recFood);
console.log(sortedDogsCopy);
*/
